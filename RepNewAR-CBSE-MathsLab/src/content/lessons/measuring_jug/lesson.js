...
export class Lesson extends PhysicalMathLabLessonBase {
  constructor() {
    super({
      id: 'measuring_jug', title: 'Measuring Jug Set — Capacity', category: 'CBSE Maths Lab • Classes 9–10', difficulty: 'Beginner',
      description: 'Use volume-level markers to compare capacities and convert mL ↔ L.', kind: 'jug', shortLabel: 'Capacity',
      activity: '750 mL', supportedMarkerIds: [1,2,3,4,5],
      defaultValue: 750, min: 0, max: 2000, step: 50
    });
  }

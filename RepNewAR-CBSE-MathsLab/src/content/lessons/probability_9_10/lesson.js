...
export class Lesson extends PhysicalMathLabLessonBase {
  constructor() {
    super({
      id: 'probability_9_10', title: 'Probability Kit — Compound Events', category: 'CBSE Maths Lab • Classes 9–10', difficulty: 'Beginner',
      description: 'Use multiple outcome markers to model experimental event frequencies.', kind: 'probability', shortLabel: 'Probability',
      activity: 'P(A) = 0.50', supportedMarkerIds: [1,2,3,4,5],

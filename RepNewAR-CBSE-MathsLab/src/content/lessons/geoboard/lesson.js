...
export class Lesson extends PhysicalMathLabLessonBase {
  constructor() {
    super({
      id: 'geoboard', title: 'Geoboard & Rubber Bands — Area', category: 'CBSE Maths Lab • Classes 6–8', difficulty: 'Beginner',
      description: 'Tags act as pegs; the AR polygon connects detected points and estimates area.', kind: 'geoboard', shortLabel: 'Area',
      activity: 'Area ≈ 6 square units', supportedMarkerIds: [1,2,3,4,5],

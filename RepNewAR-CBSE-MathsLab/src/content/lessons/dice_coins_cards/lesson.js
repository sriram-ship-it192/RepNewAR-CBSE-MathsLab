...
export class Lesson extends PhysicalMathLabLessonBase {
  constructor() {
    super({
      id: 'dice_coins_cards', title: 'Dice, Coins & Playing Cards — Probability', category: 'CBSE Maths Lab • Classes 9–10', difficulty: 'Beginner',
      description: 'Outcome markers represent repeated trials and update the experimental frequency.', kind: 'probability', shortLabel: 'Probability',
      activity: 'Experimental P = 0.50', supportedMarkerIds: [1,2,3,4,5],
      defaultValue: 60, min: 1, max: 100, step: 1
    });
  }

...
export class Lesson extends PhysicalMathLabLessonBase {
  constructor() {
    super({
      id: 'triangle_6_8', title: 'Triangle Kit — Sides & Angles', category: 'CBSE Maths Lab • Classes 6–8', difficulty: 'Beginner',
      description: 'Tags #1, #2 and #3 act as triangle vertices; AR measures sides/angles.', kind: 'triangle', shortLabel: 'Triangle',
      activity: '60° • 60° • 60°', supportedMarkerIds: [1,2,3,4,5],

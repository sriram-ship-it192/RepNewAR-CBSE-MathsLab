...
export class Lesson extends PhysicalMathLabLessonBase {
  constructor() {
    super({
      id: 'venn_diagrams', title: 'Venn Diagram Models / Charts — Sets', category: 'CBSE Maths Lab • Classes 9–10', difficulty: 'Beginner',
      description: 'Move set-member markers into the AR Venn diagram to explore union/intersection.', kind: 'venn', shortLabel: 'Sets',
      activity: 'A ∩ B = 2', supportedMarkerIds: [1,2,3,4,5],

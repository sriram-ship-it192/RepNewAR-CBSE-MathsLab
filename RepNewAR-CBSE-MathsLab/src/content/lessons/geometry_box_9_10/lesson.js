...
export class Lesson extends PhysicalMathLabLessonBase {
  constructor() {
    super({
      id: 'geometry_box_9_10', title: 'Geometry Box — Theorem & Construction', category: 'CBSE Maths Lab • Classes 9–10', difficulty: 'Beginner',
      description: 'Use marker points as construction references and inspect the generated geometry.', kind: 'geometry', shortLabel: 'Geometry',
      activity: 'Construction ready', supportedMarkerIds: [1,2,3,4,5],

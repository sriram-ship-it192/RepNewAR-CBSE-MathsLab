...
export class Lesson extends PhysicalMathLabLessonBase {
  constructor() {
    super({
      id: 'math_models_charts', title: 'Mathematical Models / Charts — Formula Explorer', category: 'CBSE Maths Lab • Classes 9–10', difficulty: 'Beginner',
      description: 'Select a model marker to reveal its formula and 3D visualization.', kind: 'models', shortLabel: 'Formula Models',
      activity: 'a² + b² = c²', supportedMarkerIds: [1,2,3,4,5],

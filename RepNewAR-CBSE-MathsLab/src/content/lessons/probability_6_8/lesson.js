...
export class Lesson extends PhysicalMathLabLessonBase {
  constructor() {
    super({
      id: 'probability_6_8', title: 'Probability Kit — Experimental Probability', category: 'CBSE Maths Lab • Classes 6–8', difficulty: 'Beginner',
      description: 'Detected outcome markers are counted as experimental trials.', kind: 'probability', shortLabel: 'Probability',
      activity: '3/5 = 60%', supportedMarkerIds: [1,2,3,4,5],
      defaultValue: 60, min: 1, max: 20, step: 1
    });
  }

...
export class Lesson extends PhysicalMathLabLessonBase {
  constructor() {
    super({
      id: 'integer_board', title: 'Integer Board — Addition & Subtraction', category: 'CBSE Maths Lab • Classes 6–8', difficulty: 'Beginner',
      description: 'Move positive/negative number markers along the integer line.', kind: 'integer', shortLabel: 'Integers',
      activity: '+3 − 5 = −2', supportedMarkerIds: [1,2,3,4,5],
      defaultValue: -2, min: -20, max: 20, step: 1
    });
  }

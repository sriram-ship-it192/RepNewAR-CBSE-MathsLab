...
export class Lesson extends PhysicalMathLabLessonBase {
  constructor() {
    super({
      id: 'sau_rang_khoj', title: 'Sau Rang Ki Khoj — Colour Patterns', category: 'CBSE Maths Lab • Classes 3–5', difficulty: 'Beginner',
      description: 'Arrange colour/pattern markers around Tag #1 to complete the sequence.', kind: 'pattern', shortLabel: 'Pattern',
      activity: 'A B A B', supportedMarkerIds: [1,2,3,4,5],

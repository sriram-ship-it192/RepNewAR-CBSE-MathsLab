...
export class Lesson extends PhysicalMathLabLessonBase {
  constructor() {
    super({
      id: 'conic_sections', title: 'Conic Section Models — Circle, Ellipse, Parabola', category: 'CBSE Maths Lab • Classes 9–10', difficulty: 'Beginner',
      description: 'Use a section marker to switch the AR model and inspect its geometry.', kind: 'conic', shortLabel: 'Conics',
      activity: 'Circle → Ellipse → Parabola', supportedMarkerIds: [1,2,3,4,5],

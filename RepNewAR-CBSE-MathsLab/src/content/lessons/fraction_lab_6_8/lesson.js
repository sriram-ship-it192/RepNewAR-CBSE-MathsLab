...
export class Lesson extends PhysicalMathLabLessonBase {
  constructor() {
    super({
      id: 'fraction_lab_6_8', title: 'Fraction Kit — Equivalent Fractions', category: 'CBSE Maths Lab • Classes 6–8', difficulty: 'Beginner',
      description: 'Arrange equivalent fraction markers around the whole.', kind: 'equivalent', shortLabel: 'Equivalent Fractions',
      activity: '1/2 = 2/4 = 4/8', supportedMarkerIds: [1,2,3,4,5],
      defaultValue: 4, min: 1, max: 8, step: 1
    });
  }

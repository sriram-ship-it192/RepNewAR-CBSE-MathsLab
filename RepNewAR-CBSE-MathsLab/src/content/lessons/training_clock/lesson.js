...
export class Lesson extends PhysicalMathLabLessonBase {
  constructor() {
    super({
      id: 'training_clock', title: 'Training Clock — Time', category: 'CBSE Maths Lab • Classes 3–5', difficulty: 'Beginner',
      description: 'Tag #1 is the clock center; Tags #2/#3 represent hour/minute hand reference points.', kind: 'clock', shortLabel: 'Time',
      activity: '10:30', supportedMarkerIds: [1,2,3,4,5],
      defaultValue: 630, min: 0, max: 1439, step: 1
    });
  }

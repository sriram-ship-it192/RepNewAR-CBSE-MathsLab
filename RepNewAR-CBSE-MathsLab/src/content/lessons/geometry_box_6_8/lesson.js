...
export class Lesson extends PhysicalMathLabLessonBase {
  constructor() {
    super({
      id: 'geometry_box_6_8', title: 'Geometry Box — Constructions', category: 'CBSE Maths Lab • Classes 6–8', difficulty: 'Beginner',
      description: 'Use marker points as construction references for rays, circles and angles.', kind: 'geometry', shortLabel: 'Geometry',
      activity: 'Angle • Line • Circle', supportedMarkerIds: [1,2,3,4,5],

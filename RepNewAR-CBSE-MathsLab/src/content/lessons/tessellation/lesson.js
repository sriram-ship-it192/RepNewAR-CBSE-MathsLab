...
export class Lesson extends PhysicalMathLabLessonBase {
  constructor() {
    super({
      id: 'tessellation', title: 'Tessellation Kit — Shapes & Patterns', category: 'CBSE Maths Lab • Classes 3–5', difficulty: 'Beginner',
      description: 'Place triangle/square/hexagon markers around the base; AR displays the repeating pattern.', kind: 'tessellation', shortLabel: 'Tessellation',
      activity: '3 shapes • 12 sides', supportedMarkerIds: [1,2,3,4,5],
      defaultValue: 3, min: 1, max: 6, step: 1
    });
  }

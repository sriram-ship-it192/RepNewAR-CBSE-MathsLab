...
export class Lesson extends PhysicalMathLabLessonBase {
  constructor() {
    super({
      id: 'mensuration', title: 'Mensuration Kit — Area & Volume', category: 'CBSE Maths Lab • Classes 9–10', difficulty: 'Beginner',
      description: 'Tags #1/#2 define measurement endpoints; AR reports length, area and perimeter.', kind: 'mensuration', shortLabel: 'Mensuration',
      activity: 'L=20 cm • W=10 cm • A=200 cm²', supportedMarkerIds: [1,2,3,4,5],
      defaultValue: 20, min: 1, max: 100, step: 1
    });
  }

...
export class Lesson extends PhysicalMathLabLessonBase {
  constructor() {
    super({
      id: 'dienes_blocks', title: 'Dienes Blocks — Place Value', category: 'CBSE Maths Lab • Classes 3–5', difficulty: 'Beginner',
      description: 'Tags represent ones/tens/hundreds/thousands blocks around the base marker.', kind: 'placevalue', shortLabel: 'Place Value',
      activity: '1,246', supportedMarkerIds: [1,2,3,4,5],
      defaultValue: 1246, min: 0, max: 9999, step: 1
    });
  }

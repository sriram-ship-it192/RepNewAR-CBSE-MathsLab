...
export class Lesson extends PhysicalMathLabLessonBase {
  constructor() {
    super({
      id: 'graph_activity_6_8', title: 'Graph Paper & Activity Materials', category: 'CBSE Maths Lab • Classes 6–8', difficulty: 'Beginner',
      description: 'Move point markers to explore Cartesian coordinates.', kind: 'graph', shortLabel: 'Coordinate Geometry',
      activity: '(3, 4)', supportedMarkerIds: [1,2,3,4,5],

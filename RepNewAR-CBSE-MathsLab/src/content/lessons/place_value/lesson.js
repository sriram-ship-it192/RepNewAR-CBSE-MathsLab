...
export class Lesson extends PhysicalMathLabLessonBase {
  constructor() {
    super({
      id: 'place_value', title: 'Place Value / Number Cards', category: 'CBSE Maths Lab • Classes 3–5', difficulty: 'Beginner',
      description: 'Move number-card markers into place-value columns.', kind: 'numbercards', shortLabel: 'Place Value',
      activity: '3,425 = 3000 + 400 + 20 + 5', supportedMarkerIds: [1,2,3,4,5],
      defaultValue: 3425, min: 0, max: 9999, step: 1
    });
  }

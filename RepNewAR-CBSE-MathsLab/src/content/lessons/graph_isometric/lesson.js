...
export class Lesson extends PhysicalMathLabLessonBase {
  constructor() {
    super({
      id: 'graph_isometric', title: 'Graph & Isometric Sheets — 3D Coordinates', category: 'CBSE Maths Lab • Classes 9–10', difficulty: 'Beginner',
      description: 'Marker positions are projected onto a 3D coordinate grid.', kind: 'graph3d', shortLabel: '3D Graphing',
      activity: '(2, 3, 4)', supportedMarkerIds: [1,2,3,4,5],
      defaultValue: 4, min: -10, max: 10, step: 1
    });
  }

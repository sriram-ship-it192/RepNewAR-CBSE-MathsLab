...
export class Lesson extends PhysicalMathLabLessonBase {
  constructor() {
    super({
      id: 'fake_money', title: 'Fake Money Kit — Counting & Change', category: 'CBSE Maths Lab • Classes 3–5', difficulty: 'Beginner',
      description: 'Use denomination cards/markers; the AR panel totals the selected amount.', kind: 'money', shortLabel: 'Money',
      activity: '₹126', supportedMarkerIds: [1,2,3,4,5],
      defaultValue: 126, min: 0, max: 1000, step: 1
    });
  }
